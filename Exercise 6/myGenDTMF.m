...
for i = (1 : length(seq))
    switch seq(i)
        case '1' 
            ...
            tmp = cos(2*pi*697*n/fs) + cos(2*pi*1209*n/fs);
        case '2'
            fprintf(1,'Number 2\n');
            tmp = cos(2*pi*697*n/fs) + cos(2*pi*1336*n/fs);
        case '3'
            fprintf(1,'Number 3\n');
            tmp = cos(2*pi*697*n/fs) + cos(2*pi*1477*n/fs);    
        case '4'
            fprintf(1,'Number 4\n');
            tmp = cos(2*pi*770*n/fs) + cos(2*pi*1209*n/fs); 
        case '5'
            fprintf(1,'Number 5\n');
            tmp = cos(2*pi*770*n/fs) + cos(2*pi*1336*n/fs); 
        case '6'
            fprintf(1,'Number 6\n');
            tmp = cos(2*pi*770*n/fs) + cos(2*pi*1477*n/fs); 
        case '7'
            fprintf(1,'Number 7\n');
            tmp = cos(2*pi*852*n/fs) + cos(2*pi*1209*n/fs); 
        case '8'
            fprintf(1,'Number 8\n');
            tmp = cos(2*pi*852*n/fs) + cos(2*pi*1336*n/fs);     
        case '9'
            fprintf(1,'Number 9\n');
            tmp = cos(2*pi*852*n/fs) + cos(2*pi*1477*n/fs);
         case '0'
            fprintf(1,'Number 0\n');
            tmp = cos(2*pi*941*n/fs) + cos(2*pi*1336*n/fs);
        case ' '
            fprintf(1,'Silent\n');
            tmp = zeros(N,1);
        otherwise
